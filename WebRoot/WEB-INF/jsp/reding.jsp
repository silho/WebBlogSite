			...
			<div id="content" class="site-content">
				<div id="primary" class="content-area">
					...
					<div id="Acontent">
						<h2>${article.title}</h2>
						<span
							STYLE="font: italic normal bolder 10pt Arial; color: #CECACA">时间：${article.date}</span>
						<span
							STYLE="font: italic normal bolder 10pt Arial; color: #CECACA;margin-left:20px">作者：<a href="${basePath}user_index.action?otherName=${article.username}">${article.username}</a></span>
						
						${article.content}<br />
					</div>
					<div style="background-color: #C8C5C5;">查看评论</div>
					<s:iterator value="#critiques">
						<div style="border-top: 2px solid #F1F1F1">
						<tr>
					...
					<br/>
					<div style="background-color: #C8C5C5;">发表评论</div> 
					<s:form action="article_addCritique">
						<s:hidden name="id"></s:hidden>
						<s:hidden name="critique_AId" value="%{#request.article.id}"></s:hidden>
						名称：
						<s:textfield name="critique_username"></s:textfield>
						正文：
						<s:textarea rows="5" cols="5" name="critique_content"></s:textarea>
						<br />
