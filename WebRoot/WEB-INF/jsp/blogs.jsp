				...
				<div id="primary" class="content-area">
					...
					<s:iterator value="#myarticles">
						<div style="border-top: 2px solid #F1F1F1; overflow: hidden">
							...
							<div>
								<span
									STYLE="font: italic normal bolder 10pt Arial; color: #CECACA">${date}</span>
								<s:a action="article_seeUI?id=%{id}"
									style="margin-left:500px;">查看全部</s:a>
								<s:if test="#otherName==null||#otherName==#session.SYS_USER.username">
